...
#include "CustomWidgets/titlewidget.h"
...
public:
    ...
    void setupUi(QDialog *Login)
    {
        ...
        title_widget->setGeometry(QRect(0, 0, 640, 41));
        title_widget->setContextMenuPolicy(Qt::NoContextMenu);
        stackedWidget = new QStackedWidget(Login);
        stackedWidget->setObjectName(QString::fromUtf8("stackedWidget"));
        stackedWidget->setGeometry(QRect(0, 49, 640, 431));
