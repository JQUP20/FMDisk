/****************************************************************************
** Meta object code from reading C++ file 'ipaddredit.h'
**
...
#include <memory>
#include "../../FMDisk/CustomControls/ipaddredit.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ipaddredit.h' doesn't include <QObject>."
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<IpAddrEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (IpAddrEdit::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IpAddrEdit::textchanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (IpAddrEdit::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IpAddrEdit::textedited)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject IpAddrEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_IpAddrEdit.data,
    qt_meta_data_IpAddrEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
